...
<head>
    ...
    <title>Tunisie Telecom Marketplace</title>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6 p-0">
                    ...
                    data-setbg="img/categories/book1.png">
            ...
            <div class="col-lg-6">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 p-0">
                        <div class="categories__item set-bg" data-setbg="img/categories/phone3.png">
                            <div class="categories__text">
                                <h4>Redme Note 13 Pro</h4>
                                <p>273 items</p>
                                <a href="#">Shop now</a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 p-0">
                        <div class="categories__item set-bg" data-setbg="img/categories/phone5.png">
                            <div class="categories__text">
                                <h4>Oppo A16K</h4>
                                <p>153 items</p>
                                <a href="#">Shop now</a>
